            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:choose>
                    <c:when test="${pageContext.request.userPrincipal.name == null}">
                        ...
                        <li>
                            <form class="navbar-form navbar-left" action="<c:url value='/login' />" method="post">
                    ...
                    <c:otherwise>
                        ...
                        <sec:authorize access="hasRole('USER')">
                            <li class="header user-icon"><a
                                    ...
                                    src="../resources/image/user.png"/></a></li>
                            <li class="header count">
                                <span>${sessionScope['cart'].size == null ? 0 : sessionScope['cart'].size}</span></li>
